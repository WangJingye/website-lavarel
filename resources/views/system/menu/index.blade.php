...
@section('content')
    <div class="btn-box clearfix">
        <a href="<?= \App\Helper\UrlHelper::instance()->to('system/menu/edit-menu') ?>">
            <div class="btn btn-success pull-right"><i class="glyphicon glyphicon-plus"></i> 创建</div>
        </a>
    </div>
    <form class="search-form" action="<?= \App\Helper\UrlHelper::instance()->to('system/menu/index') ?>" method="get">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm"
                       href="<?= \App\Helper\UrlHelper::instance()->to('system/menu/edit-menu', ['id' => $v['id']]) ?>">
