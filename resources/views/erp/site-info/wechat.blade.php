...
@section('content')
    <form class="form-box col-12 col-sm-8 col-md-6" id="save-form"
          action="<?= \App\Helper\UrlHelper::instance()->to('erp/site-info/edit') ?>" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" name="wechat_app_secret" class="form-control"
                       value="<?= $model['wechat_app_secret'] ?>" placeholder="请输入微信密钥">
            </div>
        </div>
        <div class="form-group row">
